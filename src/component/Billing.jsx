    ...
    return ( 
        <section id="product" className={layout.sectionReverse}>
            ...
            <div className={layout.sectionInfo}>
                ...
                <p className={`${styles.paragraph} max-w-[470px] mt-5`}>To safeguard and enhance the health of their community, jews zealously deploy their wealth.Instead of being satisfied with investing your cash at the best local rate</p>
